...
include::../README.adoc[tags=versions]

== Intro

WARNING: As of the time writing this manual, Neo4j 4.0 has not been released publicly.
         You can use SDN-RX against Neo4j 3.5 but than you can only use `org.neo4j.springframework.data.core.Neo4jClient` and the imperative repositories
