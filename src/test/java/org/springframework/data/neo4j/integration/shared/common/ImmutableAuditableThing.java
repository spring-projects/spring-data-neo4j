...
public final class ImmutableAuditableThing implements AuditableThing {
	...
	@PersistenceCreator
	public ImmutableAuditableThing(Long id, LocalDateTime createdAt, String createdBy, LocalDateTime modifiedAt,
	...
	public ImmutableAuditableThing withId(Long id) {
		return Objects.equals(this.id, id) ? this : new ImmutableAuditableThing(id, this.createdAt, this.createdBy,
				this.modifiedAt, this.modifiedBy, this.name);
	}

	public ImmutableAuditableThing withCreatedAt(LocalDateTime createdAt) {
		return Objects.equals(this.createdAt, createdAt) ? this : new ImmutableAuditableThing(this.id, createdAt,
				this.createdBy, this.modifiedAt, this.modifiedBy, this.name);
	}

	public ImmutableAuditableThing withCreatedBy(String createdBy) {
		return Objects.equals(this.createdBy, createdBy) ? this : new ImmutableAuditableThing(this.id, this.createdAt,
				createdBy, this.modifiedAt, this.modifiedBy, this.name);
	}

	public ImmutableAuditableThing withModifiedAt(LocalDateTime modifiedAt) {
		return Objects.equals(this.modifiedAt, modifiedAt) ? this : new ImmutableAuditableThing(this.id, this.createdAt,
				this.createdBy, modifiedAt, this.modifiedBy, this.name);
	}

	public ImmutableAuditableThing withModifiedBy(String modifiedBy) {
		return Objects.equals(this.modifiedBy, modifiedBy) ? this : new ImmutableAuditableThing(this.id, this.createdAt,
				this.createdBy, this.modifiedAt, modifiedBy, this.name);
	}

	public ImmutableAuditableThing withName(String name) {
		return Objects.equals(this.name, name) ? this : new ImmutableAuditableThing(this.id, this.createdAt,
				this.createdBy, this.modifiedAt, this.modifiedBy, name);
	}
	...
	public String toString() {
		return "ImmutableAuditableThing(id=" + this.getId() + ", createdAt=" + this.getCreatedAt() + ", createdBy="
				+ this.getCreatedBy() + ", modifiedAt=" + this.getModifiedAt() + ", modifiedBy=" + this.getModifiedBy()
				+ ", name=" + this.getName() + ")";
	}
