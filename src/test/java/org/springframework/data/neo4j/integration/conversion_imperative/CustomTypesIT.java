...
public class CustomTypesIT {
	...
	void deleteByCustomId() {
		...
		assertThat(this.neo4jOperations.count(PersonWithCustomId.class)).isEqualTo(1L);
		this.neo4jOperations.deleteById(id, PersonWithCustomId.class);
	...
	void deleteAllByCustomId() {
		...
		assertThat(this.neo4jOperations.count(PersonWithCustomId.class)).isEqualTo(2L);
		this.neo4jOperations.deleteAllById(ids, PersonWithCustomId.class);
	...
	void converterAndProjection(@Autowired EntityWithCustomTypePropertyRepository repository) {
		...
		ThingWithCustomTypesProjection projection = repository
			.converterOnProjection(ThingWithCustomTypes.CustomType.of("XYZ"));
	...
	interface EntityWithCustomTypePropertyRepository extends Neo4jRepository<ThingWithCustomTypes, Long> {
		...
		ThingWithCustomTypes findByCustomTypeCustomQuery(
		...
		ThingWithCustomTypesProjection converterOnProjection(
				@Param("customType") ThingWithCustomTypes.CustomType customType);
		...
		ThingWithCustomTypes defaultAttributeWithCoalesce(
				@Param("customType") ThingWithCustomTypes.CustomType customType);
