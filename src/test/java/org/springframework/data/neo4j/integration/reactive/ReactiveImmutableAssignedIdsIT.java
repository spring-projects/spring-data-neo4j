...
public class ReactiveImmutableAssignedIdsIT {
	...
	void saveRelationshipWithAssignedIdsContainsObjectWithIdSetForRelationshipPropertiesCollection(
		...
		StepVerifier.create(repository.saveAll(Collections.singleton(person))).assertNext(savedPerson -> {
			...
			assertThat(savedPerson.relationshipPropertiesCollection.get(0).target.someValue)
	...
	interface ReactiveImmutablePersonWithAssignedIdRepository
			extends ReactiveNeo4jRepository<ImmutablePersonWithAssignedId, Long> {
