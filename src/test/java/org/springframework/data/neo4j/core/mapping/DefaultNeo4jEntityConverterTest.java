	...
	class Reads {
		...
		void shouldCatchConversionErrors() {
			...
			assertThatExceptionOfType(TypeMismatchDataAccessException.class)
					.isThrownBy(() -> defaultNeo4jEntityAccessor.readValueForProperty(value, ClassTypeInformation.from(Date.class), null))
		...
		void shouldCatchUncoercibleErrors() {
			...
			assertThatExceptionOfType(TypeMismatchDataAccessException.class)
					.isThrownBy(
							() -> defaultNeo4jEntityAccessor.readValueForProperty(value, ClassTypeInformation.from(LocalDate.class), null))
		...
		void shouldCatchUncoerfcibleErrors() {
			...
			assertThatExceptionOfType(TypeMismatchDataAccessException.class).isThrownBy(
					() -> defaultNeo4jEntityAccessor.readValueForProperty(value, ClassTypeInformation.from(ReactiveNeo4jClient.class), null))
