 ...
 */
class DefaultNeo4jConversionServiceTests {

	private final DefaultNeo4jConversionService defaultNeo4jEntityAccessor = new DefaultNeo4jConversionService(
			new Neo4jConversions());
	...
	class Reads {
		...
		void shouldDealWith0IsoDurationsAsPeriods() {
			...
			Period period = (Period) DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor
				.readValue(zeroDuration, TypeInformation.of(Period.class), null);
		...
		void shouldDealWith0IsoDurationsAsDurations() {
			...
			Duration duration = (Duration) DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor
				.readValue(zeroDuration, TypeInformation.of(Duration.class), null);
		...
		void shouldDealWithNullTemporalValueOnRead() {
			Duration duration = (Duration) DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor
				.readValue(null, TypeInformation.of(Duration.class), null);
			assertThat(duration).isNull();
		}

		@Test // GH-2324
		void shouldDealWithNullTemporalValueOnWrite() {
			Value value = DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor.writeValue(null,
					TypeInformation.of(TemporalAmount.class), null);
		...
		void shouldCatchConversionErrors() {
			...
			assertThatExceptionOfType(TypeMismatchDataAccessException.class)
				.isThrownBy(() -> DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor.readValue(value,
						TypeInformation.of(Date.class), null))
		...
		void shouldCatchUncoercibleErrors() {
			...
			assertThatExceptionOfType(TypeMismatchDataAccessException.class)
				.isThrownBy(() -> DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor.readValue(value,
						TypeInformation.of(LocalDate.class), null))
		...
		void shouldCatchCoercibleErrors() {
			...
			assertThatExceptionOfType(TypeMismatchDataAccessException.class)
				.isThrownBy(() -> DefaultNeo4jConversionServiceTests.this.defaultNeo4jEntityAccessor.readValue(value,
						TypeInformation.of(ReactiveNeo4jClient.class), null))
