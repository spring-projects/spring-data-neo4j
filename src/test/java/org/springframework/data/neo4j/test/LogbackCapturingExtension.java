...
public final class LogbackCapturingExtension implements BeforeAllCallback, AfterEachCallback, ParameterResolver {
	...
	public void beforeAll(ExtensionContext context) {
		getOutputCapture(context).start();
	}

	private LogbackCapture getOutputCapture(ExtensionContext context) {
		return getStore(context).getOrComputeIfAbsent(LogbackCapture.class);
	}
	...
	public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) {
		return parameterContext.getParameter().getType().isAssignableFrom(LogbackCapture.class);
	}
