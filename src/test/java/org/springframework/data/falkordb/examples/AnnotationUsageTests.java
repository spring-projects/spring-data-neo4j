...
class AnnotationUsageTests {
	...
	/**
	 * Test demonstrating the structure of entities using @TargetNode annotation.
	 * This test doesn't run actual queries but shows the annotation usage patterns.
	 */
	@Test
	void demonstrateTargetNodeAnnotation() {
		...
		keanuReeves.setBorn(1964);

		// When: Creating a relationship with properties using @TargetNode
		ActedIn actedInMatrix = new ActedIn(
			keanuReeves, 
			Arrays.asList("Neo", "Mr. Anderson"), 
			1999
		);
	...
	/**
	 * This test demonstrates the various ways @Query annotation can be used.
	 * Note: This is a documentation test showing the repository method signatures.
	 */
	@Test
	...
	/**
	 * Demonstrates the relationship between @RelationshipProperties, @TargetNode, and @RelationshipId.
	 */
	@Test
