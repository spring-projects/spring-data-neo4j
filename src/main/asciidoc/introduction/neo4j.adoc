...
For more information about Indexes and Constrains in Neo4j see the http://neo4j.com/docs/developer-manual/current/#cypherdoc-labels-constraints-and-indexes[Neo4j Reference Manual].
