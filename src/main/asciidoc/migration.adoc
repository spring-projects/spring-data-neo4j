...
It is highly recommended for users starting new SDN projects to use the Neo4j-OGM `Session` directly. `Neo4jTemplate` has been kept to give upgrading users a better experience.
