...
----
@Configuration
@EnableExperimentalNeo4jRepositories(basePackages = "org.neo4j.example.repository")
...
[[reference.getting_started.spring-configuration.legacy]]
=== Spring Data Neo4j 4.0 - 4.1 Applications (Deprecated)

[WARNING]
This functionality is deprecated and only intended for users on versions of SDN prior to 4.2.x. If you are using an older
version of SDN you may try the following.
