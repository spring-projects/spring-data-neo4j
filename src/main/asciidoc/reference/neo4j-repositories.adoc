...
For persistence constructors to work, the constructor arguments names have to match the attributes names.

The current implementation has some limitations :

* entity attributes cannot be marked `final`
* relationships as constructors arguments are not fully supported.
  The relationship argument valkue will be null in the constructor and then set to the real value once the entity has been instantiated.
