 ...
 * <a href=
 * "https://neo4j.com/docs/cypher-manual/current/syntax/spatial/#cypher-spatial">Spatial
 * values</a>.
 *
...
public sealed interface Neo4jPoint permits AbstractPoint {
	...
	/**
	 * Returns the Srid identifying the Coordinate Reference Systems (CRS) used by this
	 * point.
	 * @return the Srid identifying the Coordinate Reference Systems (CRS) used by this
	 * point
	 */
	Integer getSrid();
