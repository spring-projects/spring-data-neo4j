...
/**
 * Annotation to activate Neo4j repositories. If no base package is configured through
 * either {@link #value()}, {@link #basePackages()} or {@link #basePackageClasses()} it
 * will trigger scanning of the package of annotated configuration class.
 *
 * @author Gerrit Meier
 * @since 6.0
 */
...
public @interface EnableNeo4jRepositories {
	 ...
	 * declarations e.g.: {@code @EnableNeo4jRepositories("org.my.pkg")} instead of
	 ...
	 */
	String neo4jMappingContextRef() default Neo4jRepositoryConfigurationExtension.DEFAULT_MAPPING_CONTEXT_BEAN_NAME;

	/**
	 * Configures the name of the {@link Neo4jTemplate} bean to be used with the
	 * repositories detected.
	 * @return reference to the {@link Neo4jTemplate}
	 */
	String neo4jTemplateRef() default Neo4jRepositoryConfigurationExtension.DEFAULT_NEO4J_TEMPLATE_BEAN_NAME;

	/**
	 * Configures the name of the {@link Neo4jTransactionManager} bean to be used with the
	 * repositories detected.
	 * @return reference to the {@link Neo4jTransactionManager}
	 */
	String transactionManagerRef() default Neo4jRepositoryConfigurationExtension.DEFAULT_TRANSACTION_MANAGER_BEAN_NAME;
