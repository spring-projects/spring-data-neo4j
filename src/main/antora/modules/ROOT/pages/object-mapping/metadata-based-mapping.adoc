...
See xref:appendix/conversions.adoc#conversions[] for more information on that.
...
Have a look at xref:auditing.adoc#auditing[] for all annotations regarding auditing support.
...
you can define a fine-grained description of the data that you want to fetch by using xref:projections.adoc#projections[projections].