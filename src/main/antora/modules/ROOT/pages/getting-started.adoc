...
The easiest way to set up a Spring Boot project is https://start.spring.io#!type=maven-project&dependencies=webflux,data-neo4j[start.spring.io]
...
----
include::example$documentation/domain/MovieRepository.java[tags=getting.started]
----
