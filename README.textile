...
The primary goal of the "Spring Data":http://projects.spring.io/spring-data/ is to make it easier to build Spring-powered applications that use new data access technologies such as non-relational databases, map-reduce frameworks, and cloud based data services. As the name implies, the **Graph** project provides integration with graph value stores.  The only supported Graph Database now is "Neo4j":http://neo4j.org/.
...
See also the "Spring Data Neo4J homepage":http://projects.spring.io/spring-data-neo4j/
...
The main "Spring Data website":http://www.springsource.org/spring-data contains links to basic project information such as source code, JavaDocs, Issue tracking, etc.

For more detailed questions, "ask a question on StackOverflow":http://stackoverflow.com/questions/ask?tags=spring-data-neo4j. If you are new to Spring as well as to Spring Data, look for information about "Spring projects":http://www.springsource.org/projects.

h3. Neo4j Version Support

*NOTE:* A 3.4 snapshot is listed, but this is actually version 4.0.  Version 4.0 is a rewrite of Spring Data Neo4j

|_. Neo4j Version|_. SDN4J 3.x|_. SDN4J 4.x|
|1.9|?|?|
|2.0|*Yes*|*Yes*|
|2.1|*Yes*|*Yes*|
|2.2|No|*Yes*|

h3. Neo4j Feature Support

|Feature|_. SDN4J 3.x|_. SDN4J 4.x|
|Auth|No|*Yes*|
|Remote Cypher|?|?|
|Transactions|?|?|
|High Availability|?|?|
|Embedded JVM support|*Yes*|*Yes*|

h2. Maven configuration

The current release is: !https://img.shields.io/maven-central/v/org.springframework.data/spring-data-neo4j.svg?style=plastic(Maven Central)!:http://mvnrepository.com/artifact/org.springframework.data/spring-data-neo4j
