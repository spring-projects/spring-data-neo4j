...
package org.neo4j.ogm.unit.mapper.direct.aa;
 ...
 */
public class AA extends RelationshipTest{
	...
	public void init() throws IOException {
		sessionFactory = new SessionFactory("org.neo4j.ogm.unit.mapper.direct.aa");
