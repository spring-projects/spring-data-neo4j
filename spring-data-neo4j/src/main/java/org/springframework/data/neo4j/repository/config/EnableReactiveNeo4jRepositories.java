...
/**
 * Annotation to enable Neo4j reactive repositories. Will scan the package of the annotated configuration class for
 * Spring Data repositories by default.
 *
 * @author lilt gabrielyan
 * @since 5.0
 */
...
public @interface EnableReactiveNeo4jRepositories {
	 ...
	 *
	 * @return The class of the entity to be managed by the repository
	 */
