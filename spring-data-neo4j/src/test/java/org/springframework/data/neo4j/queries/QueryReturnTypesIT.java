 ...
 * @author Mark Paluch
 */
@ContextConfiguration(classes = {QueryReturnTypesIT.GalaxyContext.class})
...
public class QueryReturnTypesIT extends MultiDriverTestClass {
	...
	static class GalaxyContext {
		...
		public SessionFactory sessionFactory() {
			return new SessionFactory(baseConfiguration.build(), "org.springframework.data.neo4j.examples.galaxy.domain");
		}
