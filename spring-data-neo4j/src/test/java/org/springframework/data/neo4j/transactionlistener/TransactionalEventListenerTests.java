package org.springframework.data.neo4j.transactionlistener;
 ...
 * <a href="https://github.com/spring-projects/spring-framework/blob/master/spring-tx/src/test/java/org/springframework/transaction/event/TransactionalEventListenerTests.java">the spring framework transactional event listener tests</a>
 * and modified to work with a version of the Neo4jTransactionManager.
 *
 * @author Mark Angrish
 * @see DATAGRAPH-883
 */
public class TransactionalEventListenerTests extends MultiDriverTestClass {
	...
	private void doLoad(Class<?>... classes) {
		...
		this.transactionTemplate = new TransactionTemplate(this.context.getBean(CallCountingTransactionManager.class));
	}
